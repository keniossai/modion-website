...
class FrontEndController extends Controller
{
    ...
    public function blog(){
        ...
        return view('pages.blog', compact(['posts', 'recentPosts', 'firstPosts2', 'middlePost', 'lastPosts', 'firstFooterPost', 'firstfooterPosts2', 'lastFooterPost']));
    }

    public function unlearn(){

        return view('pages.unlearn');
    }
    ...
    public function post($slug){
        ...
        if($post){
            return view('pages.post', compact(['post', 'posts', 'categories', 'tags', 'firstRelatedPost', 'firstRelatedPosts2', 'lastRelatedPost']));
        }else {
            return redirect('/');
        }
    }
    ...
    public function send_message(Request $request)
    {
        ...
        Session::flash('message-send', 'Thank you for contacting modion');
