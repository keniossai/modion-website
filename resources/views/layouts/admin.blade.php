...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
      <img  src="/assets/img/favicon.ico" alt="Modion Logo" class="brand-image img-circle elevation-1">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/assets/img/favicon.ico" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      <div class="mb-0">Developed By Ken Ossai</div>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="https://modioncommunications.com">Modion Communications</a></strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
